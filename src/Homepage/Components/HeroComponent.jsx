  ...
  return (<div className="relative">
          ...
          <div className="col-span-3  p-4 flex flex-col gap-[24px] ">
            <div>
              <Button varient="secondary" >
                <p className="drop-shadow-[0px_4px_4px_#00000040]">Hey! Welcome to Dot propack Industries Pvt, Ltd</p>
              </Button>
            </div>
              ...
              <div className="bg-[#FFFFFF26] p-[48px] flex gap-[12px] rounded-[4px]">
                <div className="flex flex-col gap-[8px]">
                  <div className="flex">
                    ...
                    <h3 className="text-white font-[700] text-[40px] leading-[56px] tracking-[0%] ms-[8px]">10+
                    </h3>
                  </div>
    ...
    <div className="absolute -bottom-24 w-full flex gap-[34px] justify-center">
      {ProductArray?.map((prod) => <div className="rounded-[4px] h-[200px] w-[14%] p-[4px] bg-white">
        <img src={prod?.image} className="w-full aspect-auto" />
      </div>)}
    </div>
  </div>)
}
