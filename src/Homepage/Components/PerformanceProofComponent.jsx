    ...
    <MainWidthContainer>
      <div
        ...
        <div className="col-span-5 md:col-span-3 flex flex-col gap-[24px]">
          ...
          <p className="font-[400] text-[16px] leading-[28px] md:w-[80%]  text-[#414750]">Effective progress tracking and milestone setting are critical components of Dot Propack's Top Management</p>
