  ...
  return (
    <div className="flex justify-between mt-[24px] items-center ">
      {NavArray?.map((nav, index) => (
        <div
          key={nav?.text}
          className="border-2 flex flex-col p-[24px] gap-[24px] justify-center items-center rounded-[4px] 
            w-[18%] h-[136px] transition-all duration-300 
            hover:bg-[#F3F8FF] hover:border-[#2B5592]  hover:text-[#2B5592] hover:scale-125 cursor-pointer"
        >
